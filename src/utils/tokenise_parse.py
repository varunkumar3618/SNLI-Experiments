# Source:
# https://raw.githubusercontent.com/matpalm/snli_nn_tf/master/tokenise_parse.py
...
def tokens_for(eg, sentence_idx, parse_mode="BINARY_WITHOUT_PARENTHESIS"):
    ...
    if parse_mode == "BINARY_WITHOUT_PARENTHESIS":
        ...
        raise Exception(
            "unknown parse-mode [%s] ; expected BINARY_WITHOUT_PARENTHESIS|BINARY_WITH_PARENTHESIS|PARSE_WITH_OPEN_CLOSE_TAGS" % parse_mode)
